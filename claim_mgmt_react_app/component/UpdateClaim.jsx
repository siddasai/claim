            ...
            <div>
                ...
                <Container>
                    <Card className="boxes mx-auto">
                        <Card.Header className="text-center">Update Claim</Card.Header>
                        <Card.Body>
                            <Row>
                                <Col lg={12}>
                                        ...
                                        <Form.Row>
                                            <Form.Group as={Col} md={12}>
                                                <div className="mt-4 text-center">
                                                    <button type="submit" className="btn btn-outline-primary mr-4 next" disabled={!this.state.formValid} onClick={() => this.handleSubmit()}>Next</button>
